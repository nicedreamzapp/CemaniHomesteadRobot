...
outdoor_classes = {
    ...
    "Dolphin", "Dragonfly", "Duck", "Eagle", "Falcon", "Fire hydrant", "Fish",
...
both_classes = {
    ...
    "Broccoli", "Bronze sculpture", "Burrito", "Butterfly", "Cabbage", "Canary",
    "Cantaloupe", "Carrot", "Cat", "Chainsaw", "Christmas tree", "Clothing", "Coat",
    "Cocktail", "Coconut", "Coffee", "Coin", "Common fig", "Common sunflower",
    "Computer mouse", "Cookie", "Cowboy hat", "Cream", "Crocodile", "Croissant",
    ...
    "Hamster", "Hand dryer", "Handbag", "Handgun", "Hat", "Headphones", "Heater",
    "Helmet", "High heels", "Hiking equipment", "Honeycomb", "Horse", "Hot dog",
    "Human arm", "Human beard", "Human body", "Human ear", "Human eye", "Human face",
    "Human foot", "Human hair", "Human hand", "Human head", "Human leg", "Human mouth",
    "Human nose", "Ice cream", "Insect", "Invertebrate", "Isopod", "Jacket", "Jeans",
    "Juice", "Kangaroo", "Kitchen utensil", "Kite", "Knife", "Koala", "Ladybug",
    "Lemon", "Leopard", "Lily", "Lion", "Lizard", "Lobster", "Lynx", "Magpie",
    "Mammal", "Man", "Maple", "Maracas", "Measuring cup", "Mechanical fan",
    "Microphone", "Milk", "Miniskirt", "Mirror", "Mixer", "Mixing bowl", "Mobile phone",
    "Monkey", "Moths and butterflies", "Mouse", "Muffin", "Mug", "Mule", "Mushroom",
    "Musical instrument", "Musical keyboard", "Nail (Construction)", "Necklace",
    "Nightstand", "Oboe", "Office supplies", "Orange", "Organ (Musical Instrument)",
    "Ostrich", "Otter", "Owl", "Oyster", "Paddle", "Palm tree", "Pancake", "Panda",
    "Paper cutter", "Paper towel", "Parrot", "Pasta", "Pastry", "Peach", "Pear", "Pen",
    ...
    "Scarf", "Scissors", "Scoreboard", "Screwdriver", "Sculpture", "Seat belt",
    "Serving tray", "Sewing machine", "Shark", "Sheep", "Shelf", "Shellfish", "Shirt",
    "Shorts", "Shower", "Shrimp", "Sink", "Skateboard", "Ski", "Skirt", "Skull",
    "Skunk", "Slow cooker", "Snack", "Snail", "Snake", "Snowboard", "Snowman",
    "Snowmobile", "Snowplow", "Sparrow", "Spatula", "Spice rack", "Spider", "Spoon",
    "Sports equipment", "Sports uniform", "Squash (Plant)", "Squid", "Squirrel",
